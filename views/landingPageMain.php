        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="charts.html">Students</a>
                    </li>
                    <li>
                        <a href="tables.html">Custom Page-1</a>
                    </li>
                    <li>
                        <a href="forms.html">Custom Page-2</a>
                    </li>
                    <li>
                        <a href="bootstrap-elements.html">Custom Page-3</a>
                    </li>
                    <li>
                        <a href="bootstrap-grid.html">Custom Page-4</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
